...
found = 0
for img in range(1,4+1):  # Here, 10 can be changed to whatever number you like to choose
    readpath = '/home/tamarar/Desktop/novo/Camera_calibration/calibration/image_radial_distortion/Pic_'
